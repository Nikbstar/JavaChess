...
public class Rook extends Piece {
    ...
    public Rook(final int piecePositionArg, final Alliance pieceAllianceArg) {
        super(PieceType.ROOK, piecePositionArg, pieceAllianceArg);
    }
     ...
     */
    @Override
    public Rook movePiece(final Move moveArg) {
        return new Rook(moveArg.getDestinationCoordinate(), moveArg.getMovedPiece().getPieceAlliance());
    }
