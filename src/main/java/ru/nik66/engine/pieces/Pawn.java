...
public class Pawn extends Piece {
    ...
    public Pawn(final int piecePositionArg, final Alliance pieceAllianceArg) {
        super(PieceType.PAWN, piecePositionArg, pieceAllianceArg);
    }
     ...
     */
    @Override
    public Pawn movePiece(final Move moveArg) {
        return new Pawn(moveArg.getDestinationCoordinate(), moveArg.getMovedPiece().getPieceAlliance());
    }
